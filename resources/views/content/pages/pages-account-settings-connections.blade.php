      ...
      <div class="row">
        ...
        <div class="col-md-6 col-12">
          ...
          <div class="card-body">
            ...
            <div class="d-flex mb-4 align-items-center">
              <div class="flex-shrink-0">
                <img src="{{ asset('assets/img/icons/brands/twitter-' . $configData['theme'] . '.png') }}" alt="twitter" class="me-4" height="32" data-app-dark-img="icons/brands/twitter-dark.png" data-app-light-img="icons/brands/twitter-light.png" />
              </div>
              <div class="flex-grow-1 row">
                <div class="col-7">

...
'resources/assets/vendor/libs/select2/select2.js', 'resources/assets/vendor/libs/notiflix/notiflix.js'])
@endsection
...
<div class="app-email card">
      ...
      <div class="card shadow-none border-0 rounded-0">
        ...
        <div class="email-list pt-0">
          <ul class="list-unstyled m-0">
            <li class="email-list-item email-marked-read d-flex align-items-center" data-starred="true"
              ...
              <div class="d-flex align-items-center w-100">
                ...
                <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                  ...
                  <span class="email-list-item-subject d-xl-inline-block d-block"> Focused impactful open issues from
                    the project of GitHub</span>
                </div>
                <div class="email-list-item-meta ms-auto d-flex align-items-center">
                  ...
                  <ul class="list-inline email-list-item-actions">
                    <li class="list-inline-item email-unread btn btn-icon btn-text-secondary rounded-pill"><i
                    ...
                    <li class="list-inline-item btn btn-icon btn-text-secondary rounded-pill"><i
                        class="icon-base ti tabler-info-circle icon-md"></i></li>
                  </ul>
                </div>
              </div>
            </li>
            <li class="email-list-item email-marked-read d-flex align-items-center" data-sent="true"
              data-bs-toggle="sidebar" data-target="#app-email-view">
              <div class="d-flex align-items-center w-100">
                <div class="form-check mb-0 ms-2">
                ...
                <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                  ...
                  <span class="email-list-item-subject d-xl-inline-block d-block"> Hey Katy, Dessert soufflé tootsie
                    roll soufflé carrot cake halvah jelly.</span>
                </div>
                <div class="email-list-item-meta ms-auto d-flex align-items-center">
            ...
            <li class="email-list-item email-marked-read d-flex align-items-center" data-draft="true"
              data-bs-toggle="sidebar" data-target="#app-email-view">
              <div class="d-flex align-items-center w-100">
                <div class="form-check mb-0 ms-2">
                ...
                <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                  ...
                  <span class="email-list-item-subject d-xl-inline-block d-block"> Hey Katy, Soufflé apple pie caramels
                    soufflé tiramisu bear claw.</span>
                </div>
                <div class="email-list-item-meta ms-auto d-flex align-items-center">
                  <span
            ...
            <li class="email-list-item d-flex align-items-center email-marked-read" data-starred="true"
              data-bs-toggle="sidebar" data-target="#app-email-view">
              <div class="d-flex align-items-center w-100">
                <div class="form-check mb-0 ms-2">
                ...
                <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                  ...
                  <span class="email-list-item-subject d-xl-inline-block d-block"> Hey Katy, Tart croissant jujubes
                    gummies macaroon Icing sweet.</span>
                </div>
                <div class="email-list-item-meta ms-auto d-flex align-items-center">
                  <span class="email-list-item-label badge badge-dot bg-success d-none d-md-inline-block me-2"
            ...
            <li class="email-list-item email-marked-read d-flex align-items-center" data-spam="true"
              data-bs-toggle="sidebar" data-target="#app-email-view">
              <div class="d-flex align-items-center w-100">
                <div class="form-check mb-0 ms-2">
                ...
                <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                  ...
                  <span class="email-list-item-subject d-xl-inline-block d-block"> Hey Katy, I love Pudding cookie
                    chocolate sweet tiramisu jujubes I love danish.</span>
                </div>
                <div class="email-list-item-meta ms-auto d-flex align-items-center">
                  <span class="email-list-item-label badge badge-dot bg-danger d-none d-md-inline-block me-2"
                    data-label="company"></span>
            ...
            <li class="email-list-item d-flex align-items-center email-marked-read" data-trash="true"
              data-bs-toggle="sidebar" data-target="#app-email-view">
              <div class="d-flex align-items-center w-100">
                <div class="form-check mb-0 ms-2">
                ...
                <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                  ...
                  <span class="email-list-item-subject d-xl-inline-block d-block"> Hey Katy, I love danish. Cupcake I
                    love carrot cake sugar plum I love.</span>
                </div>
                <div class="email-list-item-meta ms-auto d-flex align-items-center">
                  <span class="email-list-item-label badge badge-dot bg-primary d-none d-md-inline-block me-2"
                    data-label="work"></span>
            ...
            <li class="email-list-item email-marked-read d-flex align-items-center" data-draft="true"
              ...
              <div class="d-flex align-items-center w-100">
                ...
                <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                  ...
                  <span class="email-list-item-subject d-xl-inline-block d-block"> Hey Katy, Chocolate cake pudding
                    chocolate bar ice cream bonbon lollipop.</span>
                </div>
                <div class="email-list-item-meta ms-auto d-flex align-items-center">
                  <span class="email-list-item-label badge badge-dot bg-warning d-none d-md-inline-block me-2"
                    data-label="company"></span>
            ...
            <li class="email-list-item email-marked-read d-flex align-items-center" data-starred="true"
              ...
              <div class="d-flex align-items-center w-100">
                ...
                <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                  ...
                  <span class="email-list-item-subject d-xl-inline-block d-block"> Hey Katy, Icing gummi bears ice cream
                    croissant dessert wafer.</span>
                </div>
                <div class="email-list-item-meta ms-auto d-flex align-items-center">
                  <span
                    class="email-list-item-attachment icon-base ti tabler-paperclip icon-md cursor-pointer me-2 float-end float-sm-none"></span>
            ...
            <li class="email-list-item email-marked-read d-flex align-items-center" data-spam="true"
              ...
              <div class="d-flex align-items-center w-100">
                ...
                <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                  ...
                  <span class="email-list-item-subject d-xl-inline-block d-block"> Hey Katy, Chocolate cake pudding
                    chocolate bar ice cream Sweet.</span>
                </div>
                <div class="email-list-item-meta ms-auto d-flex align-items-center">
                  <span class="email-list-item-label badge badge-dot bg-primary d-none d-md-inline-block me-2"
                    data-label="important"></span>
            ...
            <li class="email-list-item email-marked-read d-flex align-items-center" data-trash="true"
              data-bs-toggle="sidebar" data-target="#app-email-view">
              <div class="d-flex align-items-center w-100">
                <div class="form-check mb-0 ms-2">
      ...
      <div class="card shadow-none border-0 rounded-0 app-email-view-header p-5 pt-md-4 py-2">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <div class="d-flex align-items-center overflow-hidden">
            <span class="ms-sm-2 me-4"><i class="icon-base ti tabler-chevron-left icon-md cursor-pointer scaleX-n1-rtl"
        ...
        <div class="d-flex justify-content-between align-items-center">
          <div class="d-flex align-items-center">
            <span class="btn btn-icon btn-text-secondary rounded-pill me-1"><i
                class="icon-base ti tabler-trash icon-22px cursor-pointer"></i></span>
            <span class="btn btn-icon btn-text-secondary rounded-pill me-1"><i
                class="icon-base ti tabler-mail icon-22px cursor-pointer" data-bs-toggle="sidebar"
                data-target="#app-email-view"></i></span>
            <div class="dropdown">
              <button class="btn btn-icon btn-text-secondary rounded-pill p-0 me-1" type="button"
                id="dropdownMenuFolderTwo" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <i class="icon-base ti tabler-folder icon-22px"></i>
              </button>
            ...
            <div class="dropdown">
              <button class="btn btn-icon btn-text-secondary rounded-pill p-0" type="button" id="dropdownLabelTwo"
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <i class="icon-base ti tabler-tag icon-22px"></i>
              </button>
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="dropdown ms-1">
              <button class="btn btn-icon btn-text-secondary rounded-pill p-0" type="button" id="dropdownMoreOptions"
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <i class="icon-base ti tabler-dots-vertical icon-22px"></i>
              </button>
        ...
        <div class="card email-card-prev mx-sm-6 mx-3">
          <div class="card-header d-flex justify-content-between align-items-center flex-wrap border-bottom">
            ...
            <div class="d-flex align-items-center">
              ...
              <span class="btn btn-icon btn-text-secondary rounded-pill"><i
                  class="icon-base ti tabler-paperclip icon-22px cursor-pointer"></i></span>
              <span class="btn btn-icon btn-text-secondary rounded-pill"><i
                  class="email-list-item-bookmark icon-base ti tabler-star icon-22px cursor-pointer"></i></span>
              <div class="dropdown">
                <button class="btn btn-icon btn-text-secondary rounded-pill p-0" type="button" id="dropdownEmailOne"
                  data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <i class="icon-base ti tabler-dots-vertical icon-22px"></i>
                </button>
  ...
  <!-- Compose Email -->
  <div class="app-email-compose modal" id="emailComposeSidebar" tabindex="-1" aria-labelledby="emailComposeSidebarLabel"
    aria-hidden="true">
      ...
      <div class="modal-content p-0">
        <div class="modal-header py-3 justify-content-between">
          ...
          <div class="d-flex align-items-center gap-2">
            ...
            <button type="button" class="btn btn-sm btn-icon btn-text-secondary rounded-pill" data-bs-dismiss="modal"
              aria-label="Close"><i class="icon-base ti tabler-x icon-20px"></i></button>
          </div>
        </div>
          ...
          <form class="email-compose-form">
            <div class="email-compose-to d-flex justify-content-between align-items-center">
              ...
              <div class="select2-primary border-0 shadow-none flex-grow-1 mx-2">
                <select class="select2 select-email-contacts form-select" id="emailContacts" name="emailContacts"
                  multiple>
            ...
            <div class="email-compose-actions d-flex justify-content-between align-items-center my-4">
              <div class="d-flex align-items-center">
                <div class="btn-group">
                  <button type="button" class="btn btn-primary dropdown-toggle email-send-btn" data-bs-toggle="dropdown"
                    aria-expanded="false">Send <i
                      class="icon-base ti tabler-send icon-xs scaleX-n1-rtl ms-2"></i></button>
                ...
                <label for="attach-file" class="btn btn-sm btn-icon btn-text-secondary rounded-pill ms-4"><i
                    class="icon-base ti tabler-paperclip icon-20px cursor-pointer"></i></label>
              ...
              <div class="d-flex align-items-center gap-2">
                ...
                <button type="reset" class="btn btn-sm btn-icon btn-text-secondary rounded-pill" data-bs-dismiss="modal"
                  aria-label="Close"><i class="icon-base ti tabler-trash icon-20px"></i></button>
              </div>
            </div>
          </form>
        </div>

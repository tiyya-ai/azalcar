  ...
  <footer class="footer bg-light">
    <div
      ...
      <div><a href="{{ config('variables.livePreview') }}" target="_blank"
          class="footer-text fw-medium">{{ config('variables.templateName') }}</a> ©</div>
      ...
      <div class="d-flex flex-column flex-sm-row gap-4">
        ...
        <div class="dropdown dropup footer-link">
          ...
          <div class="dropdown-menu dropdown-menu-end">
            <a class="dropdown-item" href="javascript:void(0);"><i class="icon-base ti tabler-currency-dollar"></i>
              USD</a>
            <a class="dropdown-item" href="javascript:void(0);"><i class="icon-base ti tabler-currency-euro"></i>
              Euro</a>
            <a class="dropdown-item" href="javascript:void(0);"><i class="icon-base ti tabler-currency-pound"></i>
              Pound</a>
            <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="javascript:void(0);"><i class="icon-base ti tabler-currency-bitcoin"></i>
              Bitcoin</a>
          </div>
        </div>
        <a href="javascript:void(0)" class="btn btn-sm btn-outline-danger"><i
            class="icon-base ti tabler-logout icon-xs me-1"></i>Logout</a>
      </div>
    </div>
  </footer>
</section>
...
<section id="theme-footer">
  ...
  <footer class="footer bg-footer-theme">
    <div
      class="container-fluid d-flex flex-md-row flex-column justify-content-between align-items-md-center gap-1 container-p-x py-4">
      <div>
        <a href="{{ config('variables.livePreview') }}" target="_blank" class="footer-text fw-medium"><span
            class="text-body">{{ config('variables.templateName') }}</span></a> ©
      </div>
      <div class="d-flex flex-column flex-sm-row">
        <a href="{{ config('variables.licenseUrl') }}" class="footer-link me-6" target="_blank">License</a>
        <a href="javascript:void(0)" class="footer-link me-6">Help</a>
      ...
      <div class="row">
        <div class="col-12 col-sm-6 col-md-3 mb-6 mb-sm-0">
          <h4 class="fw-bold mb-4"><a href="{{ config('variables.livePreview') }}" target="_blank"
              class="footer-text">{{ config('variables.templateName') }}
            </a></h4>
          ...
          <div class="social-icon my-4">
            <a href="javascript:void(0)" class="btn btn-icon btn-sm btn-facebook me-2"><i
                class="icon-base ti tabler-brand-facebook icon-20px"></i></a>
            <a href="javascript:void(0)" class="btn btn-icon btn-sm btn-twitter me-2"><i
                class="icon-base ti tabler-brand-twitter icon-20px"></i></a>
            <a href="javascript:void(0)" class="btn btn-icon btn-sm btn-linkedin me-2"><i
                class="icon-base ti tabler-brand-linkedin icon-20px"></i></a>
            <a href="javascript:void(0)" class="btn btn-icon btn-sm btn-github"><i
                class="icon-base ti tabler-brand-github icon-20px"></i></a>
          </div>
          <p class="pt-6">
            <script>
            ...
            © <a href="{{ config('variables.creatorUrl') }}" target="_blank"
              class="text-body">{{ config('variables.creatorName') }} </a>
          </p>
        </div>

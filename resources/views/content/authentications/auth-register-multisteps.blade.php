...
@vite(['resources/assets/vendor/libs/cleave-zen/cleave-zen.js', 'resources/assets/vendor/libs/bs-stepper/bs-stepper.js',
...
<div class="authentication-wrapper authentication-cover authentication-bg">
  ...
  <div class="authentication-inner row">
    ...
    <div
      ...
      <img src="{{ asset('assets/img/illustrations/auth-register-multisteps-shape-' . $configData['theme'] . '.png') }}"
              ...
              <div id="billingLinksValidation" class="content">
                ...
                <div class="row g-6">
                  <div class="col-md-12 form-control-validation">
                    ...
                    <div class="input-group input-group-merge">
                      <input id="multiStepsCard" class="form-control multi-steps-card" name="multiStepsCard" type="text"
                        placeholder="1356 3215 6548 7898" aria-describedby="multiStepsCardImg" />

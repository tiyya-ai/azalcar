  ...
  <div class="bs-stepper-header border-end">
    <div class="step" data-target="#deal-type">
      <button type="button" class="step-trigger">
        <span class="bs-stepper-circle"><i class="icon-base ti tabler-users icon-sm"></i></span>
    ...
    <div class="step" data-target="#deal-details">
      <button type="button" class="step-trigger">
        <span class="bs-stepper-circle"><i class="icon-base ti tabler-id icon-sm"></i></span>
        <span class="bs-stepper-label">
    ...
    <div class="step" data-target="#review-complete">
      <button type="button" class="step-trigger">
        <span class="bs-stepper-circle"><i class="icon-base ti tabler-checkbox icon-sm"></i></span>
        <span class="bs-stepper-label">
  ...
  <div class="bs-stepper-content">
    <form id="wizard-create-deal-form" onSubmit="return false">
      ...
      <div id="deal-type" class="content">
        <div class="row g-6">
          <div class="col-12">
            <div class="d-flex justify-content-center border rounded pt-2">
              <img src="{{ asset('assets/img/illustrations/wizard-create-deal-girl-with-laptop-' . $configData['theme'] . '.png') }}" alt="wizard-create-deal" data-app-light-img="illustrations/wizard-create-deal-girl-with-laptop-light.png" data-app-dark-img="illustrations/wizard-create-deal-girl-with-laptop-dark.png" width="650" class="img-fluid" />
            </div>
          </div>
          <div class="col-12">
            <div class="row">
                  ...
                  <label class="form-check-label custom-option-content" for="customRadioFlat">
                    <span class="custom-option-body">
                      <svg width="41" height="40" viewBox="0 0 41 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path
                          d="M26.5 25.25C25.9477 25.25 25.5 25.6977 25.5 26.25C25.5 26.8023 25.9477 27.25 26.5 27.25V25.25ZM31.5 27.25C32.0523 27.25 32.5 26.8023 32.5 26.25C32.5 25.6977 32.0523 25.25 31.5 25.25V27.25ZM19 25.25C18.4477 25.25 18 25.6977 18 26.25C18 26.8023 18.4477 27.25 19 27.25V25.25ZM21.5 27.25C22.0523 27.25 22.5 26.8023 22.5 26.25C22.5 25.6977 22.0523 25.25 21.5 25.25V27.25ZM4 14.1406C3.44772 14.1406 3 14.5883 3 15.1406C3 15.6929 3.44772 16.1406 4 16.1406V14.1406ZM36.5 16.1406C37.0523 16.1406 37.5 15.6929 37.5 15.1406C37.5 14.5883 37.0523 14.1406 36.5 14.1406V16.1406ZM5.25 9.75H35.25V7.75H5.25V9.75ZM35.25 9.75C35.3881 9.75 35.5 9.86193 35.5 10H37.5C37.5 8.75736 36.4926 7.75 35.25 7.75V9.75ZM35.5 10V30H37.5V10H35.5ZM35.5 30C35.5 30.1381 35.3881 30.25 35.25 30.25V32.25C36.4926 32.25 37.5 31.2426 37.5 30H35.5ZM35.25 30.25H5.25V32.25H35.25V30.25ZM5.25 30.25C5.11193 30.25 5 30.1381 5 30H3C3 31.2426 4.00736 32.25 5.25 32.25V30.25ZM5 30V10H3V30H5ZM5 10C5 9.86193 5.11193 9.75 5.25 9.75V7.75C4.00736 7.75 3 8.75736 3 10H5ZM26.5 27.25H31.5V25.25H26.5V27.25ZM19 27.25H21.5V25.25H19V27.25ZM4 16.1406H36.5V14.1406H4V16.1406Z"
                          fill="currentColor" />
                      </svg>
      ...
      <div id="review-complete" class="content">
        <div class="row g-6">
          ...
          <div class="col-xl-6 col-lg-5">
            <div class="d-flex justify-content-center border rounded pt-3">
              <img class="img-fluid scaleX-n1-rtl" src="{{ asset('assets/img/illustrations/wizard-create-deal-confirm.png') }}" alt="deal image cap" />
            </div>
          </div>
          ...
          <div class="col-12 d-flex justify-content-between">
            ...
            <button class="btn btn-success btn-submit btn-next"><span class="align-middle d-sm-inline-block d-none me-sm-2">Submit</span><i class="icon-base ti tabler-check icon-xs"></i></button>
          </div>
        </div>
      </div>
    </form>

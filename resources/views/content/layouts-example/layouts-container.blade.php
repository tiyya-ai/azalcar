...
<div class="layout-demo-wrapper">
  <div class="layout-demo-placeholder">
    ...
    <img src="{{asset('assets/img/layouts/layout-horizontal-container-'.$configData['theme'].'.png')}}"
    ...
    @else
    <img src="{{asset('assets/img/layouts/layout-container-'.$configData['theme'].'.png')}}" class="img-fluid"

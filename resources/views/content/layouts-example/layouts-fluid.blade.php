...
<div class="layout-demo-wrapper">
  <div class="layout-demo-placeholder">
    ...
    <img src="{{asset('assets/img/layouts/layout-horizontal-fluid-'.$configData['theme'].'.png')}}" class="img-fluid"
      alt="Layout fluid" data-app-light-img="layouts/layout-horizontal-fluid-light.png"
      data-app-dark-img="layouts/layout-horizontal-fluid-dark.png">
    @else
    <img src="{{asset('assets/img/layouts/layout-fluid-'.$configData['theme'].'.png')}}" class="img-fluid"

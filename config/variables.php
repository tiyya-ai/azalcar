...
return [
  ...
  "templateName" => "AutoClassified",
  "templateSuffix" => "Car Classifieds Admin Panel",
  "templateVersion" => "3.0.0",
  "templateFree" => false,
  "templateDescription" => "Car classifieds management system with comprehensive admin panel",
  "templateKeyword" => "car classifieds, vehicle listings, admin panel, car marketplace",
  ...
  "ogTitle" => "AutoClassified - Car Classifieds Admin Panel",
